        ...
        <div class="col-4">
            ...
            <input type="hidden" name="tipo" value="ativos">
                <div class="form-group busca">
                    ...
                    <input type="text" class="form-control" id="campo_busca" value="<?= isset($buscar) ? $buscar : '' ?>" name="buscar" placeholder="Buscar Cliente" required>
                

                <button type="submit" class="buscar_produto "><i class="fa fa-search"></i></button>
                    </div>
                <?php
                if (isset($buscar)) : ?>
